                ...
                <div className="flex w-full flex-col justify-center gap-4 bg-white px-2 pb-4 pt-5 dark:bg-gray-800 dark:text-gray-300">
                  ...
                  <div className="flex w-full flex-col gap-4 px-4">
                    <p className="mx-auto px-4 indent-4">
                      You have just completed<HighlightedText> {chapterNumber} </HighlightedText>Chapter exercises, Qwerty Learner has been with you
                      <HighlightedText> {dayFromFirstWord} </HighlightedText> God, we're done together.
                      <HighlightedText> {wordNumber} </HighlightedText>
                      Word exercises help you correct <HighlightedText> {sumWrongCount} </HighlightedText>Wrong input, let us cheer for your progress
                    ...
                    <p className="mx-auto px-4 indent-4">
                      Qwerty Learner has persisted <span className="font-medium ">Open source, no advertising, no commercialization</span> operations
                      <HighlightedText className="text-indigo-500"> {dayFromQwerty} </HighlightedText> sky,
                      Our goal is to provide an efficient, convenient, and distraction-free learning environment for all learners. We sincerely invite you to consider making a donation, which will be directly used to maintain Qwerty's daily operations and future development, allowing Qwerty to grow with you.
                    </p>
                    <p className="mx-auto px-4 indent-4 ">
                      To thank you for your generosity, for a single donation of 50 RMB or more, we will give you 5 Qwerty custom stickers
                      <span className="text-xs">（Mainland China only）</span>，I hope you can share your happiness with your friends
                    </p>
