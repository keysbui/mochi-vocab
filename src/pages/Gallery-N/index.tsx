                ...
                <ScrollArea.Viewport className="h-full w-full ">
                  ...
                  <div className="flex items-center justify-center pb-10 pt-[20rem] text-gray-500">
                    ...
                    <p className="mr-5 w-10/12 text-xs">
                      The dictionary data for this project comes from multiple open source projects and community contributors. We are deeply grateful and respect the intellectual property rights of every contributor.
                      These data are for personal study and research only and are strictly prohibited from being used for any commercial purpose. If you are the copyright owner of the data and believe that our use infringes your rights, please contact us via the email at the bottom of the website. Once we receive a valid copyright complaint, we will remove the relevant content or seek necessary permission as soon as possible.
                      At the same time, we also encourage all users of this data to respect the rights of copyright owners and comply with all relevant laws and regulations when using this data.
                      Please note that although we try our best to ensure the legality and accuracy of all data, we cannot make any guarantees on the accuracy, completeness, legality or reliability of any data. The risk of using this data is entirely at the user's own risk.
                    </p>
                  </div>
                </ScrollArea.Viewport>
