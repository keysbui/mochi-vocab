      ...
      {showPanel && (
        ...
        >
          <p className="text-sm text-gray-600 dark:text-gray-300">
            If you have relevant programming knowledge, you can refer to
            <a
            ...
            <br />
            <br />
            If you do not have relevant programming knowledge, you can send your dictionary requirements to{' '}
            <a href="mailto:me@kaiyi.cool" className="px-2 text-blue-500" aria-label="Send email to me@kaiyi.cool">
              me@kaiyi.cool
            </a>
            ，Or add our user community at the bottom of the page to provide feedback.
          </p>
          <br />
        </InfoPanel>
      )}
      <button className="cursor-pointer pr-6 text-sm text-indigo-500" onClick={onOpenPanel}>
        Can't find the dictionary you're looking for?
      </button>
    </>
  )
}
