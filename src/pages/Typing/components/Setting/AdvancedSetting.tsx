      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            ...
            <span className={styles.sectionDescription}>After it is turned on, the words in each practice chapter will be randomly sorted. The next chapter will take effect</span>
            <div className={styles.switchBlock}>
              ...
              <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Random${
                randomConfig.isOpen ? 'Open' : 'Close'
              }`}</span>
            </div>
          </div>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>Show previous/next word when practicing</span>
            <span className={styles.sectionDescription}>When turned on, the previous/next word will be displayed above during practice.</span>
            <div className={styles.switchBlock}>
              <Switch checked={isShowPrevAndNextWord} onChange={onToggleLastAndNextWord} className="switch-root">
                <span aria-hidden="true" className="switch-thumb" />
              </Switch>
              <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Display word${
                isShowPrevAndNextWord ? 'Open' : 'Close'
              }`}</span>
            </div>
          </div>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>Whether to ignore case</span>
            <span className={styles.sectionDescription}>When enabled, the input is not case-sensitive, so for example, both "hello" and "Hello" are considered correct.</span>
            <div className={styles.switchBlock}>
              ...
              <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Ignore case${
                isIgnoreCase ? 'Open' : 'Close'
              }`}</span>
            </div>
          </div>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>Whether to allow text selection</span>
            <span className={styles.sectionDescription}>When enabled, you can select text with the mouse</span>
            <div className={styles.switchBlock}>
              <Switch checked={isTextSelectable} onChange={onToggleTextSelectable} className="switch-root">
                <span aria-hidden="true" className="switch-thumb" />
              </Switch>
              <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Select text${
                isTextSelectable ? 'Open' : 'Close'
              }`}</span>
            </div>
          </div>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>Whether to allow prompts to be displayed in silent writing mode</span>
            <span className={styles.sectionDescription}>After it is turned on, you can hover the mouse to display the correct answer.</span>
            <div className={styles.switchBlock}>
              <Switch checked={isShowAnswerOnHover} onChange={onToggleShowAnswerOnHover} className="switch-root">
                <span aria-hidden="true" className="switch-thumb" />
              </Switch>
              <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Display prompt${
                isShowAnswerOnHover ? 'Open' : 'Close'
              }`}</span>
            </div>
          </div>
        </div>
