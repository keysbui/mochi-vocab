        ...
        <div className={styles.tabContent}>
          <div className={styles.section}>
            ...
            <span className={styles.sectionDescription}>
              Currently, the user's practice data<strong>Save only locally</strong>If you need to use Qwerty Learner on different devices, browsers or other unofficial deployments，
              You need to manually synchronize and save your data. In order to preserve your practice progress and use the data analysis and smart training features that will be launched soon,
              we recommend that you back up your data in time.
            </span>
            <span className="pl-4 text-left text-sm font-bold leading-tight text-red-500">
              For the sake of your data security, please do not modify the exported data files.
            </span>
          ...
          <div className={styles.section}>
            ...
            <span className={styles.sectionDescription}>
              Please note that importing data will<strong className="text-sm font-bold text-red-500"> Complete coverage </strong>Current data. Proceed with caution.
            </span>
