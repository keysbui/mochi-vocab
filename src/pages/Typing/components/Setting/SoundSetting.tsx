      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            ...
            <div className={styles.switchBlock}>
              ...
              <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Pronunciation${
                pronunciationConfig.isOpen ? 'Open' : 'Close'
              }`}</span>
            </div>
          ...
          {window.speechSynthesis && (
            <div className={styles.section}>
              ...
              <div className={styles.switchBlock}>
                ...
                <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Pronunciation${
                  pronunciationConfig.isTransRead ? 'Open' : 'Close'
                }`}</span>
              </div>
              <div className={styles.block}>
                <span className={styles.blockLabel}>volume</span>
          ...
          <div className={styles.section}>
            ...
            <div className={`${styles.block}`}>
              <span className={styles.blockLabel}>Key sound effects</span>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.switchBlock}>
              ...
              <span className="text-right text-xs font-normal leading-tight text-gray-600">{`Pronunciation${
                hintSoundsConfig.isOpen ? 'Open' : 'Close'
              }`}</span>
            </div>
            <div className={styles.block}>
              <span className={styles.blockLabel}>volume</span>
